      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="flex justify-center">
            <div className="w-full max-w-2xl bg-white dark:bg-gray-800 rounded-2xl p-2 shadow-2xl">
              <SearchBar />
            </div>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Lecture Notes</h3>
            <p className="text-gray-600 dark:text-gray-400">Access comprehensive lecture notes for all your courses</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Past Papers & CATs</h3>
            <p className="text-gray-600 dark:text-gray-400">Practice with previous examination papers and CATs</p>
          </div>
          ...
          <div className="text-center p-6">
            ...
            <h3 className="text-xl font-semibold mb-2 dark:text-white">Practical Manuals</h3>
