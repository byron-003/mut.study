...
import {
  ...
  BarChart3, FileSpreadsheet, Settings, LogOut, Menu, X, ChevronDown, Mail, Bell, Megaphone, MessageSquare, MessagesSquare
} from 'lucide-react';
...
const Layout = () => {
  ...
  const navItems = [
    ...
    { name: 'Forum', path: '/forum', icon: MessagesSquare, allowClassRep: false },
